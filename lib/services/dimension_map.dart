...
const Map<String, dynamic> dimensionDropdownOptions = {
  "Setting": {
    ...
    "1E - Technology & Level of Advancement": [
  ...
  "Theme": [
    ...
    "Redemption through confronting past sins",
    "The corrupting nature of unchecked ambition",
    "Preserving tradition versus embracing change",
    "Unity forged from diversity in adversity",
  ...
  "Puzzle & Final Challenge": [
    ...
    "A code-breaking task where each turn you can modify one element of a cipher. Successfully cracking the code ensures the good ending; too many incorrect changes finalize in a fail ending.",
